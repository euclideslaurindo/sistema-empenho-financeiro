...
export async function GET() {
  try {
    ...
    try {
      ...
      else throw new Error("Erro pix: " + e.message);
    }
    ...
    try {
      ...
      else throw new Error("Erro elemento: " + e.message);
    }
    ...
    try {
      ...
      else throw new Error("Erro subelemento: " + e.message);
    }
    ...
    try {
      ...
      if (e.code === 'ER_CANT_DROP_FIELD_OR_KEY' || e.code === 'ER_BAD_FIELD_ERROR') {
        ...
        results.push("Aviso: erro ao migrar/dropar elemento_subelemento: " + e.message);
      }
    }
