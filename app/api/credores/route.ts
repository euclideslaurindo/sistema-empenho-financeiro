...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const { cpfCnpj, nome, rg, endereco, banco, agencia, contaCorrente, tipoChavePix, chavePix, pis, dataExpedicao } = body;
    ...
    await query(
      `INSERT INTO credores (id, cpf_cnpj, nome, rg, pis, data_expedicao, endereco)
       VALUES (?, ?, ?, ?, ?, ?, ?)`,
      [
        id, 
        cpfCnpj.trim(), 
