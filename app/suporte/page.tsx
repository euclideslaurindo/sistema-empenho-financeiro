      ...
      <div className="p-8 max-w-[1280px] mx-auto w-full flex-1">
         ...
         <div className="flex flex-col md:flex-row gap-8">
                  ...
                  {menuItems.map((item) => (
                     <button
                        ...
                        className={`w-full flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors ${
                           activeTab === item.id 
                           ? 'bg-gradient-to-r from-slate-800 to-slate-900 text-white shadow-md shadow-slate-900/20 ring-1 ring-white/10 text-white shadow' 
                           : 'text-zinc-600 hover:bg-slate-100 hover:text-[#1e293b]'
                        }`}
                     >
            ...
            <div className="flex-1">
               {activeTab === 'chamado' && (
                  <div className="bg-white/70 backdrop-blur-md shadow-sm border border-slate-200/50 rounded-lg border border-slate-200/80 shadow-sm p-8 max-w-3xl">
                     ...
                     <div className="space-y-6">
                        <div>
                           ...
                           <select className="w-full p-2.5 border border-slate-200/80 rounded text-sm focus:outline-none focus:border-[#1e293b] text-slate-800 bg-white/70 backdrop-blur-md shadow-sm border border-slate-200/50">
                        ...
                        <div>
                           ...
                           <input type="text" placeholder="Ex: 2024NE00142" className="w-full p-2.5 border border-slate-200/80 rounded text-sm focus:outline-none focus:border-[#1e293b] text-slate-800" />
                        </div>
                        <div>
                           ...
                           <textarea 
                              ...
                              className="w-full p-3 border border-slate-200/80 bg-white/70 backdrop-blur-md shadow-sm border border-slate-200/50 rounded text-sm focus:outline-none focus:border-[#1e293b] text-slate-800 resize-none" 
                           ></textarea>
                        </div>
                        <div>
                           <label className="block text-xs font-semibold text-zinc-600 mb-2">Anexos (Opcional)</label>
                           <div className="border-2 border-dashed border-slate-200/80 rounded-lg p-6 flex flex-col items-center justify-center bg-slate-50/50 hover:bg-slate-100 transition-colors cursor-pointer text-center">
               ...
               {activeTab === 'manuais' && (
                  <div className="space-y-6">
                     <div className="bg-gradient-to-r from-slate-800 to-slate-900 text-white shadow-md shadow-slate-900/20 ring-1 ring-white/10 text-white rounded-lg p-6 shadow-md max-w-3xl">
                        ...
                        <button onClick={() => toast.info('Baixando Manual Completo...')} className="bg-white/70 backdrop-blur-md shadow-sm border border-slate-200/50 text-[#1e293b] text-sm font-bold py-2.5 px-6 rounded hover:bg-blue-50/60 transition-colors">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl">
                        {[
                           ...
                           <button key={i} onClick={() => toast.success(`Abrindo: ${title}`)} className="bg-white/70 backdrop-blur-md shadow-sm border border-slate-200/50 border border-slate-200/80 p-4 text-left rounded-lg hover:border-[#1e293b] hover:shadow-sm transition-all group">
               ...
               {activeTab === 'reforma' && (
                  <div className="bg-white/70 backdrop-blur-md shadow-sm border border-slate-200/50 rounded-lg border border-slate-200/80 shadow-sm p-8 max-w-3xl">
                     ...
                     <div className="space-y-4">
                        <div className="p-4 bg-slate-50/50 border border-slate-200/80 rounded-lg">
                           <div className="flex justify-between items-start">
                              ...
                              <button onClick={() => toast.success('Abrindo Nota Técnica...')} className="text-xs bg-gradient-to-r from-slate-800 to-slate-900 text-white shadow-md shadow-slate-900/20 ring-1 ring-white/10 text-white px-3 py-1.5 rounded font-medium hover:bg-gradient-to-r from-blue-800 to-blue-900 text-white shadow-lg shadow-blue-900/30 ring-1 ring-white/20">Acessar</button>
                           </div>
                        </div>
                        <div className="p-4 bg-slate-50/50 border border-slate-200/80 rounded-lg">
                           <div className="flex justify-between items-start">
                              ...
                              <button onClick={() => toast.success('Baixando Planilha...')} className="text-xs bg-gradient-to-r from-slate-800 to-slate-900 text-white shadow-md shadow-slate-900/20 ring-1 ring-white/10 text-white px-3 py-1.5 rounded font-medium hover:bg-gradient-to-r from-blue-800 to-blue-900 text-white shadow-lg shadow-blue-900/30 ring-1 ring-white/20">Baixar XLS</button>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               {activeTab === 'microempresas' && (
                  <div className="bg-white/70 backdrop-blur-md shadow-sm border border-slate-200/50 rounded-lg border border-slate-200/80 shadow-sm p-8 max-w-3xl">
                     ...
                     <div className="grid grid-cols-1 gap-3">
                        <button onClick={() => toast.success('Visualizando conteúdo...')} className="flex items-center p-3 border border-slate-200/80 rounded hover:bg-slate-50/50 transition-colors text-left">
                        ...
                        <button onClick={() => toast.success('Baixando Modelo...')} className="flex items-center p-3 border border-slate-200/80 rounded hover:bg-slate-50/50 transition-colors text-left">
                           <FileText className="w-5 h-5 text-zinc-500 mr-3" />
               ...
               {activeTab === 'rpa' && (
                  <div className="bg-white/70 backdrop-blur-md shadow-sm border border-slate-200/50 rounded-2xl border border-slate-200/80 shadow-sm p-8 max-w-3xl relative overflow-hidden">
                     ...
                     <div className="mb-6 relative z-10">
                        <div className="relative">
                           ...
                           <input 
                              ...
                              className="w-full pl-9 pr-4 py-2.5 bg-white border border-slate-200/80 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all text-slate-800 placeholder:text-zinc-400"
                           />
                        </div>
                     </div>
                     ...
                     <div className="space-y-4 relative z-10">
                        ...
                        {[
                           ...
                           <div key={i} className="flex justify-between items-center p-4 bg-white border border-slate-200/80 rounded-xl hover:border-slate-800 hover:shadow-sm transition-all cursor-pointer group" onClick={() => toast.success('Regra acessada')}>
                              <div className="flex items-center">
                  ...
                  <div className="bg-white/70 backdrop-blur-md shadow-sm border border-slate-200/50 rounded-2xl border border-slate-200/80 shadow-sm p-8 max-w-3xl relative overflow-hidden">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-4 relative z-10">
                        {[
                           ...
                           <button key={i} onClick={() => toast.success(`Abrindo base conectada: ${item.title}`)} className="flex flex-col p-5 bg-white border border-slate-200/80 rounded-xl text-left hover:border-slate-800 hover:shadow-sm transition-all group">
               ...
               {activeTab === 'contas' && (
                  <div className="bg-white/70 backdrop-blur-md shadow-sm border border-slate-200/50 rounded-lg border border-slate-200/80 shadow-sm p-8 max-w-3xl">
                     ...
                     <div className="p-6 bg-slate-50/50 border border-slate-200/80 rounded-lg mb-4 text-center">
                        ...
                        <button onClick={() => toast.success('Baixando PDF...')} className="bg-gradient-to-r from-slate-800 to-slate-900 text-white shadow-md shadow-slate-900/20 ring-1 ring-white/10 text-white text-sm font-bold py-2 px-6 rounded hover:bg-gradient-to-r from-blue-800 to-blue-900 text-white shadow-lg shadow-blue-900/30 ring-1 ring-white/20">Baixar PDF</button>
                     </div>
                     <button onClick={() => toast.success('Abrindo Anexos...')} className="w-full p-3 border border-slate-200/80 text-center rounded text-sm font-bold text-[#1e293b] hover:bg-slate-50/50">
                  ...
                  <div className="bg-white/70 backdrop-blur-md shadow-sm border border-slate-200/50 rounded-lg border border-slate-200/80 shadow-sm p-8 max-w-3xl">
                     ...
                     <div className="space-y-4">
                        {[
                           ...
                           <div key={i} className="flex flex-col bg-slate-50/50 border border-slate-200/80 p-4 rounded hover:border-[#1e293b] transition-colors cursor-pointer" onClick={() => toast.success('Carregando Portaria...')}>
